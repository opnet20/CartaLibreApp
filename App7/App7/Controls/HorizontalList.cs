...
namespace Xamarin.Netflix.Controls
{
    public class HorizontalList : Grid
    {
        ...
        protected virtual void SetItems()
        {
            ...
            foreach (var item in ItemsSource)
            {
                try
                {
                    _itemsStackLayout.Children.Add((GetItemView(item)).View);
                }
                catch
                { }
            }
        ...
        protected virtual ViewCell GetItemView(object item)
        {
